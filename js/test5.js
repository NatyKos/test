...
// const titles = books.map(titleOne => titleOne.title);
// console.log(titles);
// ================================
// Масив books містить колекцію об'єктів книг, кожен з яких містить властивість genres,
// значенням якої є масив жанрів.Використовуючи метод flatMap(), зроби так, щоб у змінній
...
// const totalPlayTime = playtimes.reduce((t, number) => t+number );
...
const totalAveragePlaytimePerGame = players.reduce(
    (timeGame, player) =>
     player.playtime / player.gamesPlayed + timeGame, 0);
